		...
		<div class="comt">
			<div class="comt-box">
				...
				<div class="comt-ctrl">
					...
					<span class="muted comt-smilie"><i class="icon-thumbs-up icon12"></i><a href="javascript:SIMPALED.Editor.daka()">签到</a></span>
					<span class="muted comt-smilie"><i class="icon-thumbs-up icon12"></i><a href="javascript:SIMPALED.Editor.good()">赞美</a></span>
					<span class="muted comt-smilie"><i class="icon-thumbs-up icon12"></i><a href="javascript:SIMPALED.Editor.bad()">埋怨</a></span>
					<span class="muted comt-smilie"><i class="icon-thumbs-up icon12"></i><a href="javascript:SIMPALED.Editor.pre()">代码</a></span>
