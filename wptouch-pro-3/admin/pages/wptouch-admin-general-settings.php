	...
	wptouch_add_page_section(
		...
		array(
			wptouch_add_setting( 
				'radiolist', 
				'preview_mode', 
				__( 'Preview mode', 'wptouch-pro' ), 
				__( 'Will show WPtouch Pro in desktop browsers for logged in admin users.', 'wptouch-pro' ),
				WPTOUCH_SETTING_BASIC,
				'3.0',
				array(
					'on' => __( 'On', 'wptouch-pro' ),
					'off' => __( 'Off', 'wptouch-pro' )
				)
			),
			wptouch_add_setting( 
				'checkbox', 
