...
<div class="panel panel-success">
    <div class="panel-heading">
        <h3 class="panel-title">本站允许使用开发接口，永久免费！[V1.2]<span class="label label-success" style="float: right;"><strong>由无名强力驱动</strong></span></h3>
    </div>
    <div class="input-group">
        ...
        <button type="button" class="btn btn-warning" target="_blank" onclick="top.location='wd'">启动无敌模式</button>
		</div>
		</form>
<?php
error_reporting(0);
...
<img src=’http://www.youku.com/user_getCode/?__rt=1&__ro=&mobile=1396589698′ alt=’已轰炸’/>
